...
public class Block32_5E {
     ...
     */
    public double getAmperageAnchor1_s3() {
     ...
     */
    public double getAmperageAnchor2_s3() {
     ...
     */
    public double getAmperageAnchor3_s3() {
     ...
     */
    public double getAmperageAnchor4_s3() {
     ...
     */
    public double getAmperageExcitation_s3() {
     ...
     * @return Эл. Град.
     */
    public double getAngleRegLarge_s3() {
     ...
     * @return Эл. Град.
     */
    public double getAngleRegLeast_s3() {
     ...
     * @return Эл. Град.
     */
    public double getAngle0Largest_s3() {
     ...
     * @return Эл. Град.
     */
    public double getAngle0Least_s3() {
     ...
     */
    public int getStatePowerScheme_s3() {
     ...
     */
    public int getModePowerScheme_s3() {
     ...
     */
    public int getSchema_s3() {
        int state = getStatePowerScheme_s3();
        if (state != 0x04) return 1;
        else if (getModePowerScheme_s3() == 0) return 3;
        else return 2;
    }
