...
public class Block32_5C {
     ...
     */
    public double getAmperageAnchor3_s2() {
     ...
     */
    public double getAmperageAnchor4_s2() {
     ...
     * @return Эл. Град.
     */
    public double getAngleRegLarge_s2() {
     ...
     * @return Эл. Град.
     */
    public double getAngleRegLeast_s2() {
     ...
     * @return Эл. Град.
     */
    public double getAngle0Largest_s2() {
     ...
     * @return Эл. Град.
     */
    public double getAngle0Least_s2() {
     ...
     */
    public int getStatePowerScheme_s2() {
     ...
     */
    public int getModePowerScheme_s2() {
     ...
     */
    public int getSchema_s2() {
        int state = getStatePowerScheme_s2();
        if (state != 0x04) return 1;
        else if (getModePowerScheme_s2() == 0) return 3;
        else return 2;
    }
