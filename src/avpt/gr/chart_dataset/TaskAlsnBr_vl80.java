...
public class TaskAlsnBr_vl80  extends SeriesTasks {


    public static final int ALSN_UNKNOWN = 0;
    public static final int ALSN_YELLOW = 2;
    public static final int ALSN_WHITE = 16;
    public static final int ALSN_GREEN = 1;
    public static final int ALSN_REDYELLOW = 4;
    public static final int ALSN_RED = 8;

    public TaskAlsnBr_vl80(ArrayList<ArrayList<ListTasks.ItemTask>> arrTasks, boolean isColorByIndex) {
