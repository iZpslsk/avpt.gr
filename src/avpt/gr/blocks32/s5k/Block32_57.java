...
public class Block32_57 {
    ...
    /**
     * @return множитель для общего тока (для ЭС5К)
     */
    public double getAmperageK_s5k() {
        return  1 / Math.pow(10, toUnsignedInt(values[26]) & 0x0F);
    }

    /**
     * @return множитель для напряжения контактной сети (для ЭС5К)
     */
    public double getVoltageK_s5k() {
        return  1 / Math.pow(10, toUnsignedInt(values[26]) >>> 4);
    }
