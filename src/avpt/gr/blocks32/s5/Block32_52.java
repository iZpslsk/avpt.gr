...
//            return LocalTime.of(hour, min, sec);
    ...
    public double getSpeedBoot() {
        return (toUnsignedInt(values[11]) << 8 | toUnsignedInt(values[10])) / 10.0;
    }

    /**
     * @return - задание контроллера
     */
     ...
     */
    public int getBlock() {
        return toUnsignedInt(values[11]) << 8 | toUnsignedInt(values[10]);
    }
    ...
    public int getPowerImplement() {
        return (short) (toUnsignedInt(values[9]) << 8 | toUnsignedInt(values[8]));
    }

    /**
     * @return - сила Задание контроллера
     */
    public int getPowerTaskControl() {
        return (short) (toUnsignedInt(values[15]) << 8 | toUnsignedInt(values[14]));
    }
    ...
    public int getPowerMax() {
        return (short) (toUnsignedInt(values[17]) << 8 | toUnsignedInt(values[16]));
    }
    ...
    public int getPowerMaxRec() {
        return (short) (toUnsignedInt(values[19]) << 8 | toUnsignedInt(values[18])) * -1;
    }
    ...
    public int getProtect() {
        return (toUnsignedInt(values[12]) >>> 2) & 0x01;
    }

    /**
     * @return Вмешатеьство маш-та
     */
     ...
     */
    public int getTM() {
        return (toUnsignedInt(values[12]) >>> 3) & 0x01;
    }
     ...
     */
    public int getGV() {
        return ((toUnsignedInt(values[12]) >>> 4) & 0x01) == 1 ? 0 : 1;
    }
     ...
     */
    public int getBox() {
        return toUnsignedInt(values[21]) & 0x01;
    }

    /**
     * @return Автоведение БСК
     */
    public int getAutoBSK() {
        return (toUnsignedInt(values[12]) >>> 6) & 0x01;
    }
