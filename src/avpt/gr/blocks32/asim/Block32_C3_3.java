...
public class Block32_C3_3 {

    private final byte[] values;

    public Block32_C3_3(byte[] values) {
        this.values = values;
    }
    ...
    /**
     * @return Активная энергия постоянного тока потребленная 4 секция
     */
    public long getEnergyAct_s4_dc() {
    ...
    /**
     * @return Реактивная энергия постоянного тока потребленная 4 секция
     */
    public long getEnergyReact_s4_dc() {
     ...
     */
    public long getEnergyActRec_ac_s4() {
     ...
     */
    public long getEnergyReactRec_ac_s4() {
     ...
     */
    public long getEnergyAct_s4_ac() {
     ...
     */
    public long getEnergyReAct_s4_ac() {
