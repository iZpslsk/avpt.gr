...
public class Block32_C3_0 {

    private final byte[] values;

    public Block32_C3_0(byte[] values) {
        this.values = values;
    }
    ...
    /**
     * @return Активная энергия постоянного тока потребленная 1 секция
     */
    public long getEnergyAct_s1_dc() {
    ...
    /**
     * @return Реактивная энергия постоянного тока потребленная 1 секция
     */
    public long getEnergyReact_s1_dc() {
     ...
     */
    public long getEnergyActRec_ac_s1() {
     ...
     */
    public long getEnergyReactRec_ac_s1() {
     ...
     */
    public long getEnergyAct_s1_ac() {
     ...
     */
    public long getEnergyReAct_s1_ac() {
