...
public class ChartArm extends JFreeChart {
  ...
  //  private static HashMap<Comparable<String>, Boolean> mapViewLines = new HashMap<Comparable<String>, Boolean>();
    ...
    public static final String KM130_LABEL =            "Кран 130   ";
    ...
    public ChartArm(ChartDataset chartDataset, HexTab hexTab, UtilsArmG.MutableDouble boundUpper, ChartPanelArm.ActionRepaintStatus actionRepaintStatus) {
        ...
        seriesKM130 = chartDataset.getSeriesKM130();
        ...
        if (seriesKM130 != null) plotKM130 = addTaskToPlotCombine(KM130_LABEL, seriesKM130.createDataset(), getWeight_km130(false));
...
//            SeriesLines.mapDefWeight.put(title, W_LINE);
    ...
    private XYPlot addTaskToPlotCombine(String title, IntervalXYDataset dataset, int weight) {
        ...
        if (title.equals(KM130_LABEL)) {
            renderer = chartDataset.getSeriesKM130().createRenderer();
        }
...
//            }
    ...
    public void setKM130Weight(int weight) {
        if (plotKM130 == null) return;
        plotKM130.setWeight(getWeight_km130(false));
        setWeight_km130(weight);
    }
